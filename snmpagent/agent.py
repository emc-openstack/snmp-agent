...
class SNMPEngine(object):
    def __init__(self, array_config, access_config, engine_id=None,
        ...
        self.setup_access()
        self.unity_client = self.connect_backend_device()
    ...
    def setup_transport(self):
        ...
        self.engine.registerTransportDispatcher(self.transport_dispatcher,
                                                transport_domain)
        self.engine.transportDispatcher.registerRoutingCbFun(
            lambda td, t, d: td)
    ...
    def create_managed_objects(self):
        ...
        builder.setMibSources(snmp_builder.DirMibSource('./mibs/'),
    ...
    def run(self):
        # Register an imaginary never-ending job to keep I/O dispatcher running
        # forever.
