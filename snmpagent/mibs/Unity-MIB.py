...
# Produced by pysmi-0.1.3 at Tue Jul 18 15:24:34 2017
# On host hyhit-VirtualBox platform Linux version 4.8.0-58-generic by user hyhit
...
volumeDefaultStorageProcessor = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 2, 28, 1, 8), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: volumeDefaultStorageProcessor.setStatus('mandatory')
volumeCurrentStorageProcessor = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 2, 28, 1, 9), DisplayString()).setMaxAccess("readonly")
