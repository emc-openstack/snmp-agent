...
storageProcessorNumberOfFrontendPort = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 2, 26, 1, 3), Integer32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorNumberOfFrontendPort.setStatus('mandatory')
storageProcessorNumberOfBackendPort = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 2, 26, 1, 4), Integer32()).setMaxAccess("readonly")
...
volumeNumberOfPhysicalDisk = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 2, 28, 1, 5), Integer32()).setMaxAccess("readonly")
