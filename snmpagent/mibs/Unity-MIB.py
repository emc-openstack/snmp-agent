...
# Produced by pysmi-0.1.3 at Tue Aug  8 11:13:30 2017
# On host hyhit-VirtualBox platform Linux version 4.10.0-30-generic by user hyhit
...
storageProcessorEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1), ).setIndexNames((0, "Unity-MIB", "storageProcessorName"))
if mibBuilder.loadTexts: storageProcessorEntry.setStatus('mandatory')
storageProcessorName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorName.setStatus('mandatory')
storageProcessorSerialNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorSerialNumber.setStatus('mandatory')
storageProcessorOperationalState = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorOperationalState.setStatus('mandatory')
storageProcessorCpuUtilization = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorCpuUtilization.setStatus('mandatory')
storageProcessorTotalThroughput = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 5), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorTotalThroughput.setStatus('mandatory')
storageProcessorReadThroughput = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 6), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorReadThroughput.setStatus('mandatory')
storageProcessorWriteThroughput = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 7), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorWriteThroughput.setStatus('mandatory')
storageProcessorTotalBandwidth = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 8), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorTotalBandwidth.setStatus('mandatory')
storageProcessorReadBandwidth = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 9), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorReadBandwidth.setStatus('mandatory')
storageProcessorWriteBandwidth = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 10), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorWriteBandwidth.setStatus('mandatory')
storageProcessorCacheDirtySize = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 11), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorCacheDirtySize.setStatus('mandatory')
storageProcessorReadCacheState = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 12), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: storageProcessorReadCacheState.setStatus('mandatory')
storageProcessorWriteCacheState = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 26, 1, 13), DisplayString()).setMaxAccess("readonly")
...
poolEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1), ).setMaxAccess("readonly").setIndexNames((0, "Unity-MIB", "poolName"))
if mibBuilder.loadTexts: poolEntry.setStatus('mandatory')
poolName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolName.setStatus('mandatory')
poolDiskTypes = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolDiskTypes.setStatus('mandatory')
poolRaidLevels = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolRaidLevels.setStatus('mandatory')
poolFastCacheStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolFastCacheStatus.setStatus('mandatory')
poolNumberOfPhysicalDisk = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 5), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolNumberOfPhysicalDisk.setStatus('mandatory')
poolTotalCapacity = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 6), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolTotalCapacity.setStatus('mandatory')
poolRemainingCapacity = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 7), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolRemainingCapacity.setStatus('mandatory')
poolUsedCapacity = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 8), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: poolUsedCapacity.setStatus('mandatory')
poolCapacityUtilization = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 27, 1, 9), DisplayString()).setMaxAccess("readonly")
...
diskEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1), ).setMaxAccess("readonly").setIndexNames((0, "Unity-MIB", "diskName"))
if mibBuilder.loadTexts: diskEntry.setStatus('mandatory')
diskName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskName.setStatus('mandatory')
diskModel = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskModel.setStatus('mandatory')
diskSerialNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskSerialNumber.setStatus('mandatory')
diskFirmwareVersion = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskFirmwareVersion.setStatus('mandatory')
diskType = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 5), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskType.setStatus('mandatory')
diskPhysicalLocation = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 6), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskPhysicalLocation.setStatus('mandatory')
diskStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 7), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskStatus.setStatus('mandatory')
diskRawCapacity = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 8), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskRawCapacity.setStatus('mandatory')
diskCurrentPool = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 9), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskCurrentPool.setStatus('mandatory')
diskResponseTime = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 10), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskResponseTime.setStatus('mandatory')
diskQueueLength = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 11), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskQueueLength.setStatus('mandatory')
diskTotalThroughput = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 12), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskTotalThroughput.setStatus('mandatory')
diskReadThroughput = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 13), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskReadThroughput.setStatus('mandatory')
diskWriteThroughput = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 14), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskWriteThroughput.setStatus('mandatory')
diskTotalBandwidth = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 15), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskTotalBandwidth.setStatus('mandatory')
diskReadBandwidth = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 16), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskReadBandwidth.setStatus('mandatory')
diskWriteBandwidth = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 17), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: diskWriteBandwidth.setStatus('mandatory')
diskUtilization = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 29, 1, 18), DisplayString()).setMaxAccess("readonly")
...
hostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 32, 1), ).setMaxAccess("readonly").setIndexNames((0, "Unity-MIB", "hostName"))
if mibBuilder.loadTexts: hostEntry.setStatus('mandatory')
hostName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 32, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hostName.setStatus('mandatory')
hostNetworkAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 32, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hostNetworkAddress.setStatus('mandatory')
hostInitiators = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 32, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hostInitiators.setStatus('mandatory')
hostOperationSystemVersion = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 32, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: hostOperationSystemVersion.setStatus('mandatory')
hostAssignedStorageVolumes = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 32, 1, 5), DisplayString()).setMaxAccess("readonly")
...
enclosureEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1), ).setIndexNames((0, "Unity-MIB", "enclosureName"))
if mibBuilder.loadTexts: enclosureEntry.setStatus('mandatory')
enclosureName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureName.setStatus('mandatory')
enclosureModel = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureModel.setStatus('mandatory')
enclosureSerialNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureSerialNumber.setStatus('mandatory')
enclosurePartNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosurePartNumber.setStatus('mandatory')
enclosureHealthStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 5), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureHealthStatus.setStatus('mandatory')
enclosureCurrentPower = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 6), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureCurrentPower.setStatus('mandatory')
enclosureAveragePower = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 7), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureAveragePower.setStatus('mandatory')
enclosureMaxPower = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 8), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureMaxPower.setStatus('mandatory')
enclosureCurrentTemperature = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 9), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureCurrentTemperature.setStatus('mandatory')
enclosureAverageTemperature = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 10), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: enclosureAverageTemperature.setStatus('mandatory')
enclosureMaxTemperature = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 33, 1, 11), DisplayString()).setMaxAccess("readonly")
...
powerSupplyEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1), ).setIndexNames((0, "Unity-MIB", "powerSupplyName"))
if mibBuilder.loadTexts: powerSupplyEntry.setStatus('mandatory')
powerSupplyName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: powerSupplyName.setStatus('mandatory')
powerSupplyManufacturer = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: powerSupplyManufacturer.setStatus('mandatory')
powerSupplyModel = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: powerSupplyModel.setStatus('mandatory')
powerSupplyFirmwareVersion = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: powerSupplyFirmwareVersion.setStatus('mandatory')
powerSupplyParentEnclosure = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1, 5), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: powerSupplyParentEnclosure.setStatus('mandatory')
powerSupplyStorageProcessor = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1, 6), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: powerSupplyStorageProcessor.setStatus('mandatory')
powerSupplyHealthStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 34, 1, 7), DisplayString()).setMaxAccess("readonly")
...
fanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 35, 1), ).setIndexNames((0, "Unity-MIB", "fanName"))
if mibBuilder.loadTexts: fanEntry.setStatus('mandatory')
fanName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 35, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: fanName.setStatus('mandatory')
fanSlotNumber = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 35, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: fanSlotNumber.setStatus('mandatory')
fanParentEnclosure = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 35, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: fanParentEnclosure.setStatus('mandatory')
fanHealthStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 35, 1, 4), DisplayString()).setMaxAccess("readonly")
...
bbuEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 36, 1), ).setIndexNames((0, "Unity-MIB", "bbuName"))
if mibBuilder.loadTexts: bbuEntry.setStatus('mandatory')
bbuName = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 36, 1, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: bbuName.setStatus('mandatory')
bbuManufacturer = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 36, 1, 2), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: bbuManufacturer.setStatus('mandatory')
bbuModel = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 36, 1, 3), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: bbuModel.setStatus('mandatory')
bbuFirmwareVersion = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 36, 1, 4), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: bbuFirmwareVersion.setStatus('mandatory')
bbuParentStorageProcessor = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 36, 1, 5), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: bbuParentStorageProcessor.setStatus('mandatory')
bbuHealthStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 36, 1, 6), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: bbuHealthStatus.setStatus('mandatory')
mibBuilder.exportSymbols("Unity-MIB", diskReadBandwidth=diskReadBandwidth, fanEntry=fanEntry, volumeEntry=volumeEntry, volumeResponseTime=volumeResponseTime, hostTable=hostTable, diskModel=diskModel, volumeTable=volumeTable, storageProcessorTable=storageProcessorTable, volumeTotalThroughput=volumeTotalThroughput, enclosureMaxTemperature=enclosureMaxTemperature, numberOfFrontendPort=numberOfFrontendPort, hostEntry=hostEntry, fanHealthStatus=fanHealthStatus, volumeWriteBandwidth=volumeWriteBandwidth, diskReadThroughput=diskReadThroughput, backendPortType=backendPortType, storageProcessorReadCacheState=storageProcessorReadCacheState, volumeFastCacheState=volumeFastCacheState, volumeWriteThroughput=volumeWriteThroughput, powerSupplyHealthStatus=powerSupplyHealthStatus, volumeReadThroughput=volumeReadThroughput, diskUtilization=diskUtilization, storageProcessorWriteCacheState=storageProcessorWriteCacheState, poolEntry=poolEntry, volumeTotalBandwidth=volumeTotalBandwidth, fanName=fanName, enclosureSerialNumber=enclosureSerialNumber, backendPortTotalThroughput=backendPortTotalThroughput, hostAssignedStorageVolumes=hostAssignedStorageVolumes, powerSupplyManufacturer=powerSupplyManufacturer, totalCapacity=totalCapacity, volumeCurrentStorageProcessor=volumeCurrentStorageProcessor, poolName=poolName, enclosureName=enclosureName, bbuManufacturer=bbuManufacturer, backendPortEntry=backendPortEntry, freeCapacity=freeCapacity, storageProcessorOperationalState=storageProcessorOperationalState, diskStatus=diskStatus, poolTable=poolTable, bbuEntry=bbuEntry, fanSlotNumber=fanSlotNumber, mibVersion=mibVersion, backendPortCurrentSpeed=backendPortCurrentSpeed, storageProcessorTotalBandwidth=storageProcessorTotalBandwidth, agentVersion=agentVersion, frontendPortTable=frontendPortTable, org=org, frontendPortName=frontendPortName, storageProcessorEntry=storageProcessorEntry, storageProcessorName=storageProcessorName, poolUsedCapacity=poolUsedCapacity, enclosureCurrentTemperature=enclosureCurrentTemperature, poolNumberOfPhysicalDisk=poolNumberOfPhysicalDisk, averagePower=averagePower, enclosurePartNumber=enclosurePartNumber, numberOfPhysicalDisk=numberOfPhysicalDisk, backendPortId=backendPortId, enclosureCurrentPower=enclosureCurrentPower, diskWriteThroughput=diskWriteThroughput, storageProcessorWriteBandwidth=storageProcessorWriteBandwidth, volumeOperationalState=volumeOperationalState, writeBandwidth=writeBandwidth, enterprises=enterprises, volumeId=volumeId, usedCapacity=usedCapacity, numberOfFan=numberOfFan, volumeFastCacheReadHitRate=volumeFastCacheReadHitRate, powerSupplyStorageProcessor=powerSupplyStorageProcessor, volumeRaidLevels=volumeRaidLevels, diskTotalBandwidth=diskTotalBandwidth, frontendPortWriteThroughput=frontendPortWriteThroughput, storageProcessorCacheDirtySize=storageProcessorCacheDirtySize, diskTable=diskTable, internet=internet, powerSupplyTable=powerSupplyTable, storageProcessorTotalThroughput=storageProcessorTotalThroughput, model=model, hostOperationSystemVersion=hostOperationSystemVersion, backendPortPortNumber=backendPortPortNumber, powerSupplyFirmwareVersion=powerSupplyFirmwareVersion, powerSupplyParentEnclosure=powerSupplyParentEnclosure, volumeFastCacheWriteHitRate=volumeFastCacheWriteHitRate, storageProcessorReadBandwidth=storageProcessorReadBandwidth, frontendPortReadBandwidth=frontendPortReadBandwidth, poolRemainingCapacity=poolRemainingCapacity, volumeName=volumeName, frontendPortTotalBandwidth=frontendPortTotalBandwidth, storageProcessorCpuUtilization=storageProcessorCpuUtilization, frontendPortCurrentSpeed=frontendPortCurrentSpeed, diskQueueLength=diskQueueLength, readThroughput=readThroughput, powerSupplyModel=powerSupplyModel, numberOfStorageProcessor=numberOfStorageProcessor, UnityPoll=UnityPoll, diskTotalThroughput=diskTotalThroughput, diskWriteBandwidth=diskWriteBandwidth, backendPortWriteThroughput=backendPortWriteThroughput, volumeUtilization=volumeUtilization, operationEnvironmentVersion=operationEnvironmentVersion, hostInitiators=hostInitiators, enclosureHealthStatus=enclosureHealthStatus, serialNumber=serialNumber, frontendPortReadThroughput=frontendPortReadThroughput, bbuHealthStatus=bbuHealthStatus, frontendPortTotalThroughput=frontendPortTotalThroughput, private=private, manufacturer=manufacturer, enclosureMaxPower=enclosureMaxPower, diskFirmwareVersion=diskFirmwareVersion, backendPortStatus=backendPortStatus, frontendPortWriteBandwidth=frontendPortWriteBandwidth, unityObjects=unityObjects, backendPortReadBandwidth=backendPortReadBandwidth, totalBandwidth=totalBandwidth, poolCapacityUtilization=poolCapacityUtilization, backendPortWriteBandwidth=backendPortWriteBandwidth, volumeQueueLength=volumeQueueLength, diskSerialNumber=diskSerialNumber, volumeFastCacheReadHitIOs=volumeFastCacheReadHitIOs, powerSupplyName=powerSupplyName, frontendPortStatus=frontendPortStatus, diskCurrentPool=diskCurrentPool, storageProcessorSerialNumber=storageProcessorSerialNumber, poolRaidLevels=poolRaidLevels, hostName=hostName, diskEntry=diskEntry, frontendPortSupportedSpeed=frontendPortSupportedSpeed, numberOfBackendPort=numberOfBackendPort, volumeReadBandwidth=volumeReadBandwidth, hostNetworkAddress=hostNetworkAddress, fanTable=fanTable, volumeAllocatedSize=volumeAllocatedSize, currentPower=currentPower, bbuModel=bbuModel, backendPortName=backendPortName, storageProcessorReadThroughput=storageProcessorReadThroughput, poolTotalCapacity=poolTotalCapacity, diskType=diskType, frontendPortAddress=frontendPortAddress, unity=unity, volumeSize=volumeSize, backendPortParentIoModule=backendPortParentIoModule, diskName=diskName, backendPortReadThroughput=backendPortReadThroughput, enclosureEntry=enclosureEntry, diskPhysicalLocation=diskPhysicalLocation, storageProcessorWriteThroughput=storageProcessorWriteThroughput, dod=dod, backendPortTable=backendPortTable, readBandwidth=readBandwidth, bbuParentStorageProcessor=bbuParentStorageProcessor, volumeDefaultStorageProcessor=volumeDefaultStorageProcessor, enclosureAverageTemperature=enclosureAverageTemperature, frontendPortType=frontendPortType, frontendPortEntry=frontendPortEntry, backendPortTotalBandwidth=backendPortTotalBandwidth, backendPortParentStorageProcessor=backendPortParentStorageProcessor, diskRawCapacity=diskRawCapacity, frontendPortId=frontendPortId, fanParentEnclosure=fanParentEnclosure, volumeHostInfo=volumeHostInfo, totalThroughput=totalThroughput, bbuFirmwareVersion=bbuFirmwareVersion, numberOfEnclosure=numberOfEnclosure, bbuTable=bbuTable, emc=emc, volumeFastCacheWriteHitIOs=volumeFastCacheWriteHitIOs, poolDiskTypes=poolDiskTypes, writeThroughput=writeThroughput, enclosureTable=enclosureTable, diskResponseTime=diskResponseTime, poolFastCacheStatus=poolFastCacheStatus, bbuName=bbuName, managementIP=managementIP, enclosureModel=enclosureModel, powerSupplyEntry=powerSupplyEntry, numberOfPowerSupply=numberOfPowerSupply, enclosureAveragePower=enclosureAveragePower)
