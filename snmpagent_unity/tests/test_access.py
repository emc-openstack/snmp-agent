...
class TestAccess(unittest.TestCase):
    ...
    def test_update_v3_user_no_private(self):
        name = 'user_1'
        old_user = config.UserV3ConfigEntry(
            name, enums.SecurityLevel.AUTH_PRIV,
            enums.SecurityLevel.AUTH_PRIV,
            enums.AuthProtocol.SHA, 'key123',
            enums.PrivProtocol.AES, 'key456')
        ...
        self.assertIsNone(new_user.priv_protocol)
        self.assertIsNone(new_user.priv_key.raw)

    def test_update_v3_user_invalid_auth(self):
        name = 'user_1'
        old_user = config.UserV3ConfigEntry(name, None,
                                            enums.SecurityLevel.AUTH_PRIV,
                                            enums.AuthProtocol.SHA, 'key123',
