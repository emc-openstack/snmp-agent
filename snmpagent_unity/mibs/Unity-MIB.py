...
# Produced by pysmi-0.3.4 at Sat May  9 15:26:55 2020
...
NotificationType, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, ModuleIdentity, iso, Counter32, MibIdentifier, Gauge32, TimeTicks, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "ModuleIdentity", "iso", "Counter32", "MibIdentifier", "Gauge32", "TimeTicks", "IpAddress", "Integer32")
...
liangr = MibScalar((1, 3, 6, 1, 4, 1, 1139, 103, 1, 19, 1027222), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: liangr.setStatus('mandatory')
...
mibBuilder.exportSymbols("Unity-MIB", poolName=poolName, numberOfStorageProcessor=numberOfStorageProcessor, enclosureAverageTemperature=enclosureAverageTemperature, frontendPortTotalThroughput=frontendPortTotalThroughput, frontendPortCurrentSpeed=frontendPortCurrentSpeed, frontendPortReadBandwidth=frontendPortReadBandwidth, backendPortStatus=backendPortStatus, diskTable=diskTable, backendPortParentStorageProcessor=backendPortParentStorageProcessor, enclosureModel=enclosureModel, storageProcessorFastCacheReadHitIOs=storageProcessorFastCacheReadHitIOs, powerSupplyId=powerSupplyId, fanId=fanId, storageProcessorReadBandwidth=storageProcessorReadBandwidth, storageProcessorId=storageProcessorId, poolTotalCapacity=poolTotalCapacity, sysDescr=sysDescr, sysContact=sysContact, volumeEntry=volumeEntry, manufacturer=manufacturer, bbuName=bbuName, numberOfFan=numberOfFan, totalThroughput=totalThroughput, poolId=poolId, volumeWriteBandwidth=volumeWriteBandwidth, storageProcessorCpuUtilization=storageProcessorCpuUtilization, volumeTotalBandwidth=volumeTotalBandwidth, enclosureId=enclosureId, bbuFirmwareVersion=bbuFirmwareVersion, diskTotalThroughput=diskTotalThroughput, poolNumberOfPhysicalDisk=poolNumberOfPhysicalDisk, enclosureTable=enclosureTable, backendPortParentIoModule=backendPortParentIoModule, storageProcessorEntry=storageProcessorEntry, diskId=diskId, diskPhysicalLocation=diskPhysicalLocation, diskUtilization=diskUtilization, mib_2=mib_2, hostId=hostId, private=private, frontendPortEntry=frontendPortEntry, volumeAllocatedSize=volumeAllocatedSize, powerSupplyFirmwareVersion=powerSupplyFirmwareVersion, usedCapacity=usedCapacity, storageProcessorCacheDirtySize=storageProcessorCacheDirtySize, enclosureEntry=enclosureEntry, emc=emc, numberOfEnclosure=numberOfEnclosure, mibVersion=mibVersion, storageProcessorReadThroughput=storageProcessorReadThroughput, storageProcessorFastCacheReadHitRate=storageProcessorFastCacheReadHitRate, enclosureSerialNumber=enclosureSerialNumber, diskType=diskType, operationEnvironmentVersion=operationEnvironmentVersion, dod=dod, sysObjectID=sysObjectID, poolUsedCapacity=poolUsedCapacity, org=org, powerSupplyName=powerSupplyName, fanEntry=fanEntry, frontendPortWriteBandwidth=frontendPortWriteBandwidth, storageProcessorReadCacheState=storageProcessorReadCacheState, frontendPortSupportedSpeed=frontendPortSupportedSpeed, volumeQueueLength=volumeQueueLength, backendPortPortNumber=backendPortPortNumber, currentPower=currentPower, readThroughput=readThroughput, diskEntry=diskEntry, enclosurePartNumber=enclosurePartNumber, frontendPortWriteThroughput=frontendPortWriteThroughput, frontendPortReadThroughput=frontendPortReadThroughput, bbuId=bbuId, volumeWriteThroughput=volumeWriteThroughput, volumeId=volumeId, backendPortEntry=backendPortEntry, fanName=fanName, diskWriteBandwidth=diskWriteBandwidth, frontendPortAddress=frontendPortAddress, fanTable=fanTable, frontendPortId=frontendPortId, volumeSize=volumeSize, frontendPortTotalBandwidth=frontendPortTotalBandwidth, backendPortName=backendPortName, diskCurrentPool=diskCurrentPool, diskName=diskName, totalCapacity=totalCapacity, powerSupplyStorageProcessor=powerSupplyStorageProcessor, poolRaidLevels=poolRaidLevels, diskReadBandwidth=diskReadBandwidth, diskWriteThroughput=diskWriteThroughput, powerSupplyManufacturer=powerSupplyManufacturer, hostOperationSystemVersion=hostOperationSystemVersion, sysName=sysName, bbuEntry=bbuEntry, storageProcessorSerialNumber=storageProcessorSerialNumber, storageProcessorWriteThroughput=storageProcessorWriteThroughput, serialNumber=serialNumber, numberOfBackendPort=numberOfBackendPort, readBandwidth=readBandwidth, hostName=hostName, storageProcessorWriteBandwidth=storageProcessorWriteBandwidth, averagePower=averagePower, volumeFastCacheState=volumeFastCacheState, diskFirmwareVersion=diskFirmwareVersion, numberOfPhysicalDisk=numberOfPhysicalDisk, diskQueueLength=diskQueueLength, fanParentEnclosure=fanParentEnclosure, volumeTable=volumeTable, bbuParentStorageProcessor=bbuParentStorageProcessor, bbuHealthStatus=bbuHealthStatus, mgmt=mgmt, hostTable=hostTable, volumeHostInfo=volumeHostInfo, backendPortId=backendPortId, poolRemainingCapacity=poolRemainingCapacity, diskRawCapacity=diskRawCapacity, internet=internet, system=system, diskModel=diskModel, poolDiskTypes=poolDiskTypes, frontendPortTable=frontendPortTable, enterprises=enterprises, poolTable=poolTable, diskSerialNumber=diskSerialNumber, powerSupplyParentEnclosure=powerSupplyParentEnclosure, storageProcessorFastCacheWriteHitRate=storageProcessorFastCacheWriteHitRate, fanHealthStatus=fanHealthStatus, hostNetworkAddress=hostNetworkAddress, diskStatus=diskStatus, hostEntry=hostEntry, diskResponseTime=diskResponseTime, writeBandwidth=writeBandwidth, volumeReadBandwidth=volumeReadBandwidth, unity=unity, fanSlotNumber=fanSlotNumber, storageProcessorTotalThroughput=storageProcessorTotalThroughput, volumeOperationalState=volumeOperationalState, backendPortCurrentSpeed=backendPortCurrentSpeed, UnityPoll=UnityPoll, volumeCurrentStorageProcessor=volumeCurrentStorageProcessor, storageProcessorTotalBandwidth=storageProcessorTotalBandwidth, numberOfFrontendPort=numberOfFrontendPort, model=model, bbuTable=bbuTable, volumeTotalThroughput=volumeTotalThroughput, backendPortType=backendPortType, enclosureAveragePower=enclosureAveragePower, unityObjects=unityObjects, volumeRaidLevels=volumeRaidLevels, backendPortTable=backendPortTable, bbuModel=bbuModel, frontendPortType=frontendPortType, powerSupplyTable=powerSupplyTable, storageProcessorFastCacheWriteHitIOs=storageProcessorFastCacheWriteHitIOs, storageProcessorTable=storageProcessorTable, writeThroughput=writeThroughput, hostAssignedStorageVolumes=hostAssignedStorageVolumes, enclosureHealthStatus=enclosureHealthStatus, enclosureMaxTemperature=enclosureMaxTemperature, frontendPortName=frontendPortName, bbuManufacturer=bbuManufacturer, enclosureMaxPower=enclosureMaxPower, sysLocation=sysLocation, powerSupplyModel=powerSupplyModel, poolFastCacheStatus=poolFastCacheStatus, storageProcessorName=storageProcessorName, freeCapacity=freeCapacity, enclosureCurrentPower=enclosureCurrentPower, volumeReadThroughput=volumeReadThroughput, diskReadThroughput=diskReadThroughput, volumeDefaultStorageProcessor=volumeDefaultStorageProcessor, poolEntry=poolEntry, enclosureName=enclosureName, liangr=liangr, frontendPortStatus=frontendPortStatus, enclosureCurrentTemperature=enclosureCurrentTemperature, numberOfPowerSupply=numberOfPowerSupply, storageProcessorWriteCacheState=storageProcessorWriteCacheState, agentVersion=agentVersion, volumeName=volumeName, poolCapacityUtilization=poolCapacityUtilization, powerSupplyEntry=powerSupplyEntry, volumeUtilization=volumeUtilization, managementIP=managementIP, diskTotalBandwidth=diskTotalBandwidth, totalBandwidth=totalBandwidth, storageProcessorOperationalState=storageProcessorOperationalState, powerSupplyHealthStatus=powerSupplyHealthStatus, hostInitiators=hostInitiators, volumeResponseTime=volumeResponseTime)
